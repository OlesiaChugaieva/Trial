    ...
    return(
        <>
            <div className={style.profileBlock}>
                {!props.profile.changer? <img className={style.imgProfile} src={'http://localhost:3001/static/img/'+props.profile.avatar} alt=""/> : <UploadAvatar setProfile={props.setProfile} reloadWithImg={props.changeFormBio}/>}
